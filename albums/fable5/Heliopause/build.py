#!/usr/bin/env python3
"""build.py — render or verify *Heliopause* (two tracks).
...
ALBUM = "Heliopause"
SEEDS = {1: 20260709, 2: 20260710}
PART_MODULES = {1: movements.PART1_MODULES, 2: movements.PART2_MODULES}
COMMENT = ("A two-part synth instrumental in the Jean-Michel Jarre / "
           "Oxygene idiom: sequencer cells with filters in motion, "
           "portamento leads, wind transitions, sudden drops. Part Two's "
           "lead is Part One's theme inverted. "
...
def build_album():
    ...
    manifest = {
        ...
        "style": "two-part synth instrumental in the Jarre / Oxygene "
                 "idiom: sequencers, portamento leads, drops, a "
                 "machine-verified inverted-theme mirror",
