#!/usr/bin/env python3
"""build.py — render or verify *Sub Rosa* (one track).
...
ALBUM = "Sub Rosa"
TITLE = "Sub Rosa"
FILE = "01 - Sub Rosa.mid"
SEED = 20260707
COMMENT = ("An Enigma-inspired instrumental: plainsong over a fast "
           "programmed groove, a melodic synth-bass hook, a bamboo flute "
           "answering the choir, and a whispered Latin text. "
           "Composed and rendered by Claude Fable 5.")

# Documented seam carry-overs as (ch, lo_beat, hi_beat) note-START
# exemptions for check_movement_bounds.  All current seams are sustains
# that start inside their movement, so the list is empty.
...
def build_album() -> None:
    ...
    manifest = {
        ...
        "style": "Enigma-inspired downtempo-gone-fast instrumental: "
                 "chant, groove, melodic synth bass, shakuhachi",
        "track_count": 1,
