"""verify.py — the shared structural-oracle library of *The Remaining*.

(The Through Lines library, verbatim.)  PARAMETERIZED: every check
reads its requirement data from the track module (movements/tNN_*.py)
instead of album-level constants, because each of the five tracks
