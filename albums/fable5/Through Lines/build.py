#!/usr/bin/env python3
"""build.py — render or verify *Through Lines* (fifteen tracks).

    python build.py                     rebuild all 15 MIDIs into midi/
                                        + album_manifest.json
...
def _default_comment(module) -> str:
    return (f"Track {module.NUMBER:02d} of '{conductor.ALBUM}', a double "
