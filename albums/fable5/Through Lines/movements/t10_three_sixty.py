"""t10_three_sixty — Track 10 "Three-Sixty" of *Through Lines*.
...
PART = conductor.Part(
    ...
    program_changes=[(CH_KIT, 0.0, 1)],     # non-zero: the v2 kit
)

# -- verification config (consumed by verify.run_track) ---------------------
PROGRAM_WHITELIST: set[int] = {39, 46, 49, 52, 55, 61, 81, 89,
                               114, 117, 118, 119}
...
def _b_outro(sc: en.Score) -> None:
    ...
    en.arp(sc, CH_HARP, [52, 59, 64, 71, 76, 79, 83, 88], OUTRO[0],
           count=8, step=0.5, vel=62, pattern="up")
