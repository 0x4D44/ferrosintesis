//! Embedded CC0 FreePats honky-tonk player-piano samples (GM0 acoustic-grand alternate bank 8).
//!
...
static SAMPLES: [(&str, &[u8]); FILE_COUNT] = [
    (
        "honkytonk_C2.wav",
        include_bytes!("../samples/honkytonk_C2.wav"),
    ),
    (
        "honkytonk_C3.wav",
        include_bytes!("../samples/honkytonk_C3.wav"),
    ),
    (
        "honkytonk_C4.wav",
        include_bytes!("../samples/honkytonk_C4.wav"),
    ),
    (
        "honkytonk_C5.wav",
        include_bytes!("../samples/honkytonk_C5.wav"),
    ),
    (
        "honkytonk_C6.wav",
        include_bytes!("../samples/honkytonk_C6.wav"),
    ),
    (
        "honkytonk_F#3.wav",
        include_bytes!("../samples/honkytonk_F#3.wav"),
    ),
    (
        "honkytonk_F#5.wav",
        include_bytes!("../samples/honkytonk_F#5.wav"),
    ),
    (
        "honkytonk_F2.wav",
        include_bytes!("../samples/honkytonk_F2.wav"),
    ),
    (
        "honkytonk_F4.wav",
        include_bytes!("../samples/honkytonk_F4.wav"),
    ),
];
