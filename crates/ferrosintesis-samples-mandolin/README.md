...
two dynamic layers, mono 16-bit 44.1 kHz.
...
measured roots, intonation notes, the layer-selection measurement and the known weak point are
in `PROVENANCE.md`. Consumers normally reach this crate through `ferrosintesis`.
