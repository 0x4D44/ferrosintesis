...
static SAMPLES: &[(&str, &[u8])] = &[
    ...
    ("banjo_A#4.wav", include_bytes!("../samples/banjo_A#4.wav")),
    ("banjo_A3.wav", include_bytes!("../samples/banjo_A3.wav")),
    ("banjo_A4.wav", include_bytes!("../samples/banjo_A4.wav")),
    ("banjo_B3.wav", include_bytes!("../samples/banjo_B3.wav")),
    ("banjo_C#5.wav", include_bytes!("../samples/banjo_C#5.wav")),
    ("banjo_C4.wav", include_bytes!("../samples/banjo_C4.wav")),
    ("banjo_C5.wav", include_bytes!("../samples/banjo_C5.wav")),
    ("banjo_D#3.wav", include_bytes!("../samples/banjo_D#3.wav")),
    ("banjo_D#4.wav", include_bytes!("../samples/banjo_D#4.wav")),
    ("banjo_D#5.wav", include_bytes!("../samples/banjo_D#5.wav")),
    ("banjo_D4.wav", include_bytes!("../samples/banjo_D4.wav")),
    ("banjo_D5.wav", include_bytes!("../samples/banjo_D5.wav")),
    ("banjo_E4.wav", include_bytes!("../samples/banjo_E4.wav")),
    ("banjo_E5.wav", include_bytes!("../samples/banjo_E5.wav")),
    ("banjo_F#4.wav", include_bytes!("../samples/banjo_F#4.wav")),
    ("banjo_F3.wav", include_bytes!("../samples/banjo_F3.wav")),
    ("banjo_F4.wav", include_bytes!("../samples/banjo_F4.wav")),
    ("banjo_G#3.wav", include_bytes!("../samples/banjo_G#3.wav")),
    ("banjo_G#4.wav", include_bytes!("../samples/banjo_G#4.wav")),
    ("banjo_G#5.wav", include_bytes!("../samples/banjo_G#5.wav")),
    ("banjo_G3.wav", include_bytes!("../samples/banjo_G3.wav")),
    ("banjo_G4.wav", include_bytes!("../samples/banjo_G4.wav")),
    ("banjo_G5.wav", include_bytes!("../samples/banjo_G5.wav")),
    ...
    (
        "musicbox_E5.wav",
        include_bytes!("../samples/musicbox_E5.wav"),
    ),
    (
        "musicbox_A5.wav",
        include_bytes!("../samples/musicbox_A5.wav"),
    ),
    (
        "musicbox_B5.wav",
        include_bytes!("../samples/musicbox_B5.wav"),
    ),
    (
        "musicbox_C6.wav",
        include_bytes!("../samples/musicbox_C6.wav"),
    ),
    (
        "musicbox_D6.wav",
        include_bytes!("../samples/musicbox_D6.wav"),
    ),
    (
        "musicbox_E6.wav",
        include_bytes!("../samples/musicbox_E6.wav"),
    ),
    (
        "musicbox_F6.wav",
        include_bytes!("../samples/musicbox_F6.wav"),
    ),
    (
        "musicbox_G#6.wav",
        include_bytes!("../samples/musicbox_G#6.wav"),
    ),
    (
        "musicbox_A6.wav",
        include_bytes!("../samples/musicbox_A6.wav"),
    ),
    (
        "musicbox_B6.wav",
        include_bytes!("../samples/musicbox_B6.wav"),
    ),
    (
        "musicbox_C7.wav",
