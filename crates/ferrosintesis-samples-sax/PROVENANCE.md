...
voices (soprano/alto/tenor/baritone sax): 74 mono 16-bit 44.1 kHz FLACs — for
...
MTG.SoloSax repository. The FLACs under `samples/` are **packaged data, not build output** —
...
`sax_bar_G#3_p.flac` and `sax_bar_G#3_f.flac` are packaged but **do not appear in any
