...
static SAMPLES: [(&str, &[u8]); FILE_COUNT] = [
    (
        "ydpgrand_C2.flac",
        include_bytes!("../samples/ydpgrand_C2.flac"),
    ),
    (
        "ydpgrand_C3.flac",
        include_bytes!("../samples/ydpgrand_C3.flac"),
    ),
    (
        "ydpgrand_C4.flac",
        include_bytes!("../samples/ydpgrand_C4.flac"),
    ),
    (
        "ydpgrand_C5.flac",
        include_bytes!("../samples/ydpgrand_C5.flac"),
    ),
    (
        "ydpgrand_C6.flac",
        include_bytes!("../samples/ydpgrand_C6.flac"),
    ),
    (
        "ydpgrand_F#2.flac",
        include_bytes!("../samples/ydpgrand_F#2.flac"),
    ),
    (
        "ydpgrand_F#3.flac",
        include_bytes!("../samples/ydpgrand_F#3.flac"),
    ),
    (
        "ydpgrand_F#4.flac",
        include_bytes!("../samples/ydpgrand_F#4.flac"),
    ),
    (
        "ydpgrand_F#5.flac",
        include_bytes!("../samples/ydpgrand_F#5.flac"),
    ),
];
...
mod tests {
    ...
    const EXPECTED_BYTES: usize = 445614;
