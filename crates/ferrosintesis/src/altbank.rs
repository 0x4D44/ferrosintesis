...
pub fn make(
    ...
    match program {
        ...
        // MM-BUG-KILN-00015 batch 2 — the pre-sampling model preserved as the CC0!=0 alt
        ...
        11 | 32 => crate::voices::make(program, key, vel, sr, seed, false),
...
mod tests {
    ...
    fn altbank_sampled_programs_preserve_pure_model_and_default_layers() {
        ...
        for (prog, key, alt) in [(11u8, 60u8, 1u8), (14u8, 65u8, 3u8), (32u8, 40u8, 1u8)] {
