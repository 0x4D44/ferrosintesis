...
//! The default `embedded-samples` feature compiles roughly 51.5 MiB of recorded audio
//! across 1026 WAV/FLAC recordings from first-party asset crates into the binary. The
