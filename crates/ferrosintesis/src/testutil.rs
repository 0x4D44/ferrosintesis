...
mod pluck_baseline {
    ...
    const HEAD_BASELINE: &[HeadRow] = &[
        ...
        ("STEEL", 40, 50, -40.19, 2.72, -3.4, 1.89),
        ("STEEL", 40, 100, -28.43, 3.13, -1.9, 2.08),
        ("STEEL", 40, 120, -24.92, 3.20, -1.6, 2.03),
        ("STEEL", 52, 50, -42.69, 3.52, -6.1, 2.63),
        ("STEEL", 52, 100, -30.05, 3.88, -3.3, 2.18),
        ("STEEL", 52, 120, -26.67, 4.00, -2.9, 2.26),
        ("STEEL", 64, 50, -47.77, 8.10, -8.1, 3.33),
        ("STEEL", 64, 100, -33.45, 6.57, -6.4, 2.77),
        ("STEEL", 64, 120, -29.97, 6.46, -5.4, 2.72),
        ("JAZZ", 40, 50, -36.93, 1.84, -8.8, 1.81),
        ("JAZZ", 40, 100, -26.97, 1.88, -7.5, 3.36),
        ("JAZZ", 40, 120, -24.35, 1.89, -7.2, 3.56),
        ...
        ("DULCIMER", 40, 50, -34.01, 2.37, -5.1, 1.72),
        ("DULCIMER", 40, 100, -22.07, 2.32, -4.7, 1.89),
        ("DULCIMER", 40, 120, -18.97, 2.31, -4.4, 1.99),
        ("DULCIMER", 52, 50, -35.85, 3.23, -5.8, 3.27),
        ("DULCIMER", 52, 100, -24.28, 3.29, -4.7, 2.65),
        ("DULCIMER", 52, 120, -20.94, 3.19, -4.5, 2.44),
        ("DULCIMER", 64, 50, -39.89, 6.49, -10.0, 2.06),
        ("DULCIMER", 64, 100, -26.44, 4.70, -6.5, 1.79),
        ("DULCIMER", 64, 120, -22.76, 4.28, -6.0, 1.78),
    ];
