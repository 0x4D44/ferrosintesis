...
The best way to hear the piece is through **[`../hollowsynth`](../hollowsynth/)**,
...
cd ..\hollowsynth
cargo build --release
.\target\release\hollowsynth.exe "..\Hollow Hill\midi\01 - Hollow Hill, Part One.mid" -o "..\Hollow Hill\audio\01 - Hollow Hill, Part One.wav"
.\target\release\hollowsynth.exe "..\Hollow Hill\midi\02 - Hollow Hill, Part Two.mid" -o "..\Hollow Hill\audio\02 - Hollow Hill, Part Two.wav"
```
