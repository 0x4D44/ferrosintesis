...
55–71, which hollowsynth cannot voice), the nine-bell ledger, the two
scored silences, the build/drop **dynamic-arc contour**, and pan/bend
hygiene. If a change breaks an oracle, fix the music — never the test.
