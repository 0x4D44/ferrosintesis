...
Render with **[`../hollowsynth`](../hollowsynth/)** v0.6, which grew three
...
cd ..\hollowsynth
cargo build --release
.\target\release\hollowsynth.exe "..\The Signal Fire\midi\01 - The Signal Fire.mid" -o "..\The Signal Fire\audio\01 - The Signal Fire.wav"
```
