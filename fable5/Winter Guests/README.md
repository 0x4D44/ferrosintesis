...
Render with **[`../hollowsynth`](../hollowsynth/)** v0.7, which grew a set of
...
cd ..\hollowsynth
cargo build --release
.\target\release\hollowsynth.exe "..\Winter Guests\midi\01 - Winter Guests, Part One.mid" -o "..\Winter Guests\audio\01 - Winter Guests, Part One.wav"
.\target\release\hollowsynth.exe "..\Winter Guests\midi\02 - Winter Guests, Part Two.mid" -o "..\Winter Guests\audio\02 - Winter Guests, Part Two.wav"
```
...
hollowsynth features a stock wavetable will ignore.
